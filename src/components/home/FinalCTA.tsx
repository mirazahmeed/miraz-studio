      ...
      <div className="studio-container">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="pt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/contact"
              className="w-full sm:w-auto px-8 py-4 bg-[#111111] hover:bg-[#222222] text-white text-[12px] font-medium uppercase tracking-[0.16em] transition-all rounded-full flex items-center justify-center gap-2"
            >
            ...
            <Link
              href="/work"
              className="w-full sm:w-auto px-8 py-4 border border-[#E6E6E4] hover:bg-neutral-50 text-[#111111] text-[12px] font-medium uppercase tracking-[0.16em] transition-all rounded-full flex items-center justify-center gap-2"
            >
